...
一次 clone 包含两棵树。OrgRebase 与 OAC 的自有材料，包括文档，适用 Apache-2.0。当前公开修订是 `main`。标签 `v0.4.0` 是产品 0.4.0 在 PolyForm Noncommercial 时期的快照。
...
许可索引：[LICENSES.md](LICENSES.md)。仓库自有材料适用 Apache-2.0。
