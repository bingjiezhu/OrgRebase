...
version: 1.3.0
contract: ../../../skills/enterprise-launch-readiness/contract.json
---

# Enterprise Launch Readiness

Use this Skill only when the input is a schema-valid `orgrebase.impact-result.v1`
from a fresh, approved Preview. The canonical Skill Contract version is `1.3` in
`skills/enterprise-launch-readiness/contract.json`; this file is the AgentTeams adapter
