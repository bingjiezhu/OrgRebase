...
- Project-owned OrgRebase and OAC material is Apache-2.0, including documentation. An intermediate commit licensed prose as CC BY 4.0. Tag `v0.4.0` and earlier public revisions remain PolyForm Noncommercial 1.0.0.
