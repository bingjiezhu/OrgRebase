...
The workspace-root copy is [`COMMUNITY.md`](../../COMMUNITY.md) at the GitHub
repository root. Keep both files in sync.
...
| Dependency updates | Dependabot watches `/orgrebase`, `/oac-spec`, and GitHub Actions |
...
|---|---|---|
| Control plane, WebUI, CLI | `src/orgrebase/` | PolyForm Noncommercial 1.0.0; commercial use needs a written grant |
