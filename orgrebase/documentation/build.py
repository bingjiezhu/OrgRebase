...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="orgrebase-docs-") as temp:
        ...
        (pages / "source-version.zh.md").write_text(
            ...
            "OrgRebase为source-available，商业用途需另行书面许可；建站不改变任何软件或数据许可。"
        ...
        (pages / "source-version.en.md").write_text(
            ...
            "OrgRebase is source-available and commercial use requires separate written permission. A local site build changes no license and does not push or publish a public website.\n",
            encoding="utf-8",
        )
