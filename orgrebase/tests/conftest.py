...
from tests.postgres_support import postgres_cluster, postgres_dsn, postgres_runtime  # noqa: F401


@pytest.fixture(autouse=True)
def local_demo_environment(monkeypatch):
    """Local fixtures opt in; deployment-boundary tests explicitly clear this."""
